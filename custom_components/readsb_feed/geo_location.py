...
async def async_setup_platform(
    ...
    """Set up the readsb Feed platform."""
    ...
    manager = ReadsbFeedEntityManager(
...
class ReadsbFeedEntityManager:
    ...
    def __init__(
        ...
        self._feed_manager = ReadsbFeedManager(
            websession,
    ...
    async def _generate_entity(self, external_id):
        """Generate new entity."""
        new_entity = ReadadsbLocationEvent(self, external_id)
...
class ReadsbLocationEvent(GeolocationEvent):
    """This represents an external event with Readsb data."""
    ...
    def _update_from_feed(self, feed_entry):
        ...
        self._distance = feed_entry.distance
